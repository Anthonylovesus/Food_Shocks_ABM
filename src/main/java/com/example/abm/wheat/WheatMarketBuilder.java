...
import com.example.abm.wheat.agents.*;
...
public class WheatMarketBuilder extends DefaultContext<Object> implements ContextBuilder<Object> {
  ...
  static {
    WHOLESALE_MARKUP.put("WHEAT", 0.10);
  }
  ...
  static {
    TASTE_MEAN.put("WHEAT", 0.10);        TASTE_STD.put("WHEAT", 0.05);
  }
  ...
  public Context build(Context<Object> context) {
    ...
    // agents
    producers.add(new ProducerAgent(1, "WHEAT", P, ml));
    ...
    schedule.schedule(
    		  ...
    		  (IAction) () -> WheatMarketBuilder.this.writeOutputs()
    		);
  ...
  public void writeOutputs() {
	  ...
	  System.out.println("[WheatMarketBuilder] Writing CSVs to: " + dir.getAbsolutePath());
	  
	  try {
	    tracker.writeCSVs(outDir);
	  } catch (Exception ex) {
	    System.err.println("[WheatMarketBuilder] tracker.writeCSVs failed:");
	    ex.printStackTrace();
	  }

	  System.out.println("[WheatMarketBuilder] writeOutputs completed.");
	}
