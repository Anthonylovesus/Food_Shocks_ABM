...
private double WHEAT_TO_FLOUR_YIELD = 0.80;   // 80% of input product are converted into output product

@Parameter(displayName = "Wheat → Flour Yield", usageName = "WHEAT_TO_FLOUR_YIELD")
public double getWHEAT_TO_FLOUR_YIELD() { return WHEAT_TO_FLOUR_YIELD; }
public void setWHEAT_TO_FLOUR_YIELD(double v) { this.WHEAT_TO_FLOUR_YIELD = v; }
  ...
  private String ML_MONTHLY_PATH =
      "data/trading_economics_wheat_wholesale_international_2023_rf.csv";
  ...
  private String CONSUMER_CSV_PATH = "data/wheat_02212025_02.csv";
