...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    pc.addParameter("ML_MONTHLY_PATH",  String.class,
        "data/tomatoes_prices_miami_fl_vine_ripes_roma_per_lb_monthly_rf.csv", true);
    pc.addParameter("CONSUMER_CSV_PATH", String.class,
        "data/tomatoes_02212025_02.csv", true);
    ...
    TomatoesMarketBuilder builder = new TomatoesMarketBuilder();
