...
public class ModelParams {
  ...
  private double INPUT_TO_OUTPUT_YIELD = 0.50;   // 50% of input product are converted into output product

  @Parameter(displayName = "Tomatoes → Canned Tomato", usageName = "INPUT_TO_OUTPUT_YIELD")
  ...
  private String ML_MONTHLY_PATH =
      "data/apple_prices_detroit_red_fuji_honeycrisp_perlb_monthly_rf.csv";
  ...
  private String CONSUMER_CSV_PATH = "data/tomatoes_02212025_02.csv";
