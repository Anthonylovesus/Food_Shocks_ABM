...
import com.example.abm.tomatoes.agents.*;
...
public class TomatoesMarketBuilder extends DefaultContext<Object> implements ContextBuilder<Object> {
  ...
  static {
    WHOLESALE_MARKUP.put("ROMA", 0.15);
  ...
  static {
    TASTE_MEAN.put("ROMA", 0.20);  TASTE_STD.put("ROMA", 0.10);
  ...
  public Context build(Context<Object> context) {
    ...
    producers.add(new ProducerAgent(2, "ROMA",       P, ml));
