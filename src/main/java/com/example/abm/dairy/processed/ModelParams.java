...
public class ModelParams {
  ...
  private double INPUT_TO_OUTPUT_YIELD = 0.25;   // 25% of input product are converted into output product

  @Parameter(displayName = "Milk → Cheese", usageName = "INPUT_TO_OUTPUT_YIELD")
  ...
  private String ML_MONTHLY_PATH =
      "data/ams_milk_two_percent_retail_detroit_mi_2021_rf.csv";
  ...
  private String CONSUMER_CSV_PATH = "data/milk_02212025_02.csv";
