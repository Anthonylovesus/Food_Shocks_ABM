...
public class ModelParams {
  ...
  private int STEPS_PER_YEAR = 52;

  @Parameter(displayName = "Steps per Year (Weekly of 52 Steps)", usageName = "STEPS_PER_YEAR")
  ...
  private String ML_MONTHLY_PATH =
      "data/potato_prices_detroit_red_white_russet_monthly_rf.csv";
  ...
  private String CONSUMER_CSV_PATH = "data/potatoes_02212025_02.csv";
