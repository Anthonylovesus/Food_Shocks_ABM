package com.example.abm.potatoes.agents;

import com.example.abm.potatoes.MLPriceLoader;

import com.example.abm.potatoes.ModelParams;
...
public class ProducerAgent {
  ...
  public ProducerAgent(int id, String variety, ModelParams P, MLPriceLoader ml) {
    ...
    this.productionCost =
        "RED DELICIOUS".equals(variety) ? 0.25 :
        "FUJI".equals(variety)          ? 0.3 : 0.35;
  }
  ...
  public void produce() {
    int rate =
        "RED DELICIOUS".equals(variety) ? 50 :
        "FUJI".equals(variety)          ? 30 : 15;
