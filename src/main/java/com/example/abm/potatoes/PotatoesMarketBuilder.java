...
import com.example.abm.potatoes.agents.*;
import com.example.abm.potatoes.MathUtil;
...
public class PotatoesMarketBuilder extends DefaultContext<Object> implements ContextBuilder<Object> {

  // varieties and purchase priority
  private static final List<String> VARIETIES =
      Arrays.asList("ROUND RED", "ROUND WHITE", "RUSSET");
  ...
  static {
    WHOLESALE_MARKUP.put("ROUND RED", 0.15);
    WHOLESALE_MARKUP.put("ROUND WHITE", 0.10);
    WHOLESALE_MARKUP.put("RUSSET", 0.08);
  }
  ...
  static {
    TASTE_MEAN.put("ROUND RED", 0.20); TASTE_STD.put("ROUND RED", 0.10);
    TASTE_MEAN.put("ROUND WHITE", 0.10); TASTE_STD.put("ROUND WHITE", 0.05);
    TASTE_MEAN.put("RUSSET", 0.0); TASTE_STD.put("RUSSET", 0.0);
  }

  // WTP jitter + bounds
  private static final double WTP_JITTER_SIGMA = 0.10;
  private static final double WTP_MIN = 0.25;
  private static final double WTP_MAX = 1.50;
  ...
  public Context build(Context<Object> context) {
    ...
    // agents
    producers.add(new ProducerAgent(1, "ROUND RED", P, ml));
    producers.add(new ProducerAgent(2, "ROUND WHITE", P, ml));
    producers.add(new ProducerAgent(3, "RUSSET", P, ml));
    ...
    schedule.schedule(
    		  ...
    		  (IAction) () -> PotatoesMarketBuilder.this.writeOutputs()
    		);
  ...
  public void step() {
    ...
    for (ConsumerAgent c : consumers) c.credit(CONSUMER_WEEKLY_INCOME);
