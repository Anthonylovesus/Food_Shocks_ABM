...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    pc.addParameter("STEPS_PER_YEAR", Integer.class, 52, true);
    ...
    pc.addParameter("initial_funds_consumers",   Double.class, 100.0, true);
    ...
    pc.addParameter("ML_MONTHLY_PATH",  String.class,
        "data/potato_prices_detroit_red_white_russet_monthly_rf.csv", true);
    pc.addParameter("CONSUMER_CSV_PATH", String.class,
        "data/potatoes_02212025_02.csv", true);
    ...
    PotatoesMarketBuilder builder = new PotatoesMarketBuilder();
